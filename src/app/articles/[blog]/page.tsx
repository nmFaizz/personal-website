...
export default async function SingleArticlePage({
  ...
  const datePublished = new Date(post!.date).toLocaleString(
    "en-US",
    dateOptions
  );
        ...
        <>
          <div className="">
            ...
            <div className="py-4 text-center base-border-b">
              <Typography size="2xl" element="h1">
                {post.title}
              </Typography>

              <Typography size="base" element="p" className="text-main-silver">
              ...
              <div className="flex gap-2 items-center text-[13px] md:text-[16px] mt-16">
                ...
                <Typography
                  size="custom"
                  className="border-b-[1px] border-green-mint"
                >
